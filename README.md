...
Exposed a `visual_only` argument, such that there's option to only load the visual part (and not the text part). Savings in GPU memory is not large, can only save about 190MiB from not loading the text model. 
